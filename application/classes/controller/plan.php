    ...
    public function action_zatwierdz() {
        ...
        foreach ($_POST['Poniedziałek'] as $lek => $przedm) {
            if ($przedm == '---') {
                ...
                $isf->DbDelete('planlek', 'dzien="Poniedziałek" and lekcja="' . $lek . '" and klasa="' . $klasa . '"');
                $isf->DbDelete('plan_grupy', 'dzien="Poniedziałek" and lekcja="' . $lek . '" and sala="' . $przedm[1] . '"');
                if (count($przedm) == 1) {
                    $colval = array(
                        'dzien' => 'Poniedziałek',
                        'klasa' => $klasa,
        ...
        foreach ($_POST['Wtorek'] as $lek => $przedm) {
            if ($przedm == '---') {
                ...
                $isf->DbDelete('planlek', 'dzien="Wtorek" and lekcja="' . $lek . '" and klasa="' . $klasa . '"');
                $przedm = explode(':', $przedm);
                $isf->DbDelete('plan_grupy', 'dzien="Wtorek" and lekcja="' . $lek . '" and sala="' . $przedm[1] . '"');
                if (count($przedm) == 1) {
                    $colval = array(
                        'dzien' => 'Wtorek',
                        'klasa' => $klasa,
        ...
        foreach ($_POST['Środa'] as $lek => $przedm) {
            if ($przedm == '---') {
                ...
                $isf->DbDelete('planlek', 'dzien="Środa" and lekcja="' . $lek . '" and klasa="' . $klasa . '"');
                $przedm = explode(':', $przedm);
                $isf->DbDelete('plan_grupy', 'dzien="Środa" and lekcja="' . $lek . '" and sala="' . $przedm[1] . '"');
                if (count($przedm) == 1) {
                    $colval = array(
                        'dzien' => 'Środa',
                        'klasa' => $klasa,
        ...
        foreach ($_POST['Czwartek'] as $lek => $przedm) {
            if ($przedm == '---') {
                ...
                $isf->DbDelete('planlek', 'dzien="Czwartek" and lekcja="' . $lek . '" and klasa="' . $klasa . '"');
                $przedm = explode(':', $przedm);
                $isf->DbDelete('plan_grupy', 'dzien="Czwartek" and lekcja="' . $lek . '" and sala="' . $przedm[1] . '"');
                if (count($przedm) == 1) {
                    $colval = array(
                        'dzien' => 'Czwartek',
                        'klasa' => $klasa,
        ...
        foreach ($_POST['Piątek'] as $lek => $przedm) {
            if ($przedm == '---') {
                ...
                $isf->DbDelete('planlek', 'dzien="Piątek" and lekcja="' . $lek . '" and klasa="' . $klasa . '"');
                $przedm = explode(':', $przedm);
                $isf->DbDelete('plan_grupy', 'dzien="Piątek" and lekcja="' . $lek . '" and sala="' . $przedm[1] . '"');
                if (count($przedm) == 1) {
                    $colval = array(
                        'dzien' => 'Piątek',
                        'klasa' => $klasa,
